...
#All images resized to 256*256 to represent HR and 64*64 to represent LR.
----------------------------------------------------------------------------
import os
import cv2
import numpy as np
...
n=7000
lr_list = os.listdir("data/srgan/lr_images")[:n]

lr_images = []
for img in lr_list:
    img_lr = cv2.imread("data/srgan/lr_images/" + img)
    img_lr = cv2.cvtColor(img_lr, cv2.COLOR_BGR2RGB)
    lr_images.append(img_lr)   


hr_list = os.listdir("data/srgan/hr_images")[:n]
   
hr_images = []
for img in hr_list:
    img_hr = cv2.imread("data/srgan/hr_images/" + img)
